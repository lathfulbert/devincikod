<?php $__view->setExtends('backend.layouts.master'); ?>

<?php $__view->startSection("title"); echo  isset($title) ? $title : 'Dashboard'; $__view->endSection(); ?>

<?php $__view->startSection('css'); ?>
<link rel="stylesheet" type="text/css" href="<?= e(asset('assets/css/vendors/animate.css')) ?>">
<link rel="stylesheet" type="text/css" href="<?= e(asset('assets/css/vendors/jquery.dataTables.css')) ?>">
<link rel="stylesheet" type="text/css" href="<?= e(asset('assets/css/vendors/select.bootstrap5.css')) ?>">
...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h3><?= e(isset($title) ? $title : 'Dashboard') ?></h3>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= e(route('admin.dashboard')) ?>"> <svg class="stroke-icon">
                                <use href="<?= e(asset('assets/svg/icon-sprite.svg#stroke-home')) ?>"></use>
                            </svg></a></li>
                    <li class="breadcrumb-item">Dashboard</li>
                    <li class="breadcrumb-item active"><?= e(isset($title) ? $title : 'Default') ?></li>
                </ol>
            </div>
        </div>
    </div>
...
<?php $__view->endSection(); ?>
                <div class="card-body">
                    <div class="d-flex media-wrapper justify-content-between">
                        <div class="flex-grow-1">
                            <div class="greeting-user">
                                ...
                                <div class="whatsnew-btn"><a class="btn btn-outline-white" href="<?= e(route('admin.profile')) ?>"
                    ...
                    <div class="cartoon"><img class="img-fluid" src="<?= e(asset('assets/images/dashboard/cartoon.svg')) ?>"
                                ...
                                <div class="widget-round secondary">
                                    <div class="bg-round">
                                        ...
                                        <svg class="half-circle svg-fill">
                                            <use href="<?= e(asset('assets/svg/icon-sprite.svg#halfcircle')) ?>"></use>
                                        </svg>
                                    </div>
                                </div>
                                <div>
                        ...
                        <table class="table" id="top-customer">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                src="<?= e(asset('assets/images/dashboard/user/2.jpg')) ?>"
                                                alt="user">
                                            <div class="img-content-box"><a class="f-w-500"
                                                    href="<?= e(route('admin.list_products')) ?>">Jane Cooper</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                src="<?= e(asset('assets/images/dashboard/user/3.jpg')) ?>"
                                                alt="user">
                                            <div class="img-content-box"><a class="f-w-500"
                                                    href="<?= e(route('admin.list_products')) ?>">Wade Warren</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                src="<?= e(asset('assets/images/dashboard/user/4.jpg')) ?>"
                                                alt="user">
                                            <div class="img-content-box"><a class="f-w-500"
                                                    href="<?= e(route('admin.list_products')) ?>">Guy Hawkins</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                src="<?= e(asset('assets/images/dashboard/user/5.jpg')) ?>"
                                                alt="user">
                                            <div class="img-content-box"><a class="f-w-500"
                                                    href="<?= e(route('admin.list_products')) ?>">Jake Spy</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                src="<?= e(asset('assets/images/dashboard-9/user/1.png')) ?>"
                                                alt="user">
                                            <div class="img-content-box"><a class="f-w-500"
                                                    href="<?= e(route('admin.list_products')) ?>">Devin Jake</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                src="<?= e(asset('assets/images/dashboard-9/user/2.png')) ?>"
                                                alt="user">
                                            <div class="img-content-box"><a class="f-w-500"
                                                    href="<?= e(route('admin.list_products')) ?>">Jacob Jones</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                src="<?= e(asset('assets/images/dashboard-9/user/5.png')) ?>"
                                                alt="user">
                                            <div class="img-content-box"><a class="f-w-500"
                                                    href="<?= e(route('admin.list_products')) ?>">Jams Bone</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex"><img class="img-fluid img-40 rounded-circle me-2"
                                                src="<?= e(asset('assets/images/dashboard-9/user/3.png')) ?>"
                                                alt="user">
                                            <div class="img-content-box"><a class="f-w-500"
                                                    href="<?= e(route('admin.list_products')) ?>">Mili Pais</a>
                        ...
                        <li class="d-flex">
                            ...
                            <div class="w-100 ms-3">
                                ...
                                <ul class="common-flex pb-1">
                                    <li><img class="img-fluid" src="<?= e(asset('assets/images/dashboard/bg-1.png')) ?>"
                                            alt="background"></li>
                                    <li><img class="img-fluid" src="<?= e(asset('assets/images/dashboard/bg-2.png')) ?>"
                                            alt="background"></li>
                                    <li><img class="img-fluid" src="<?= e(asset('assets/images/dashboard/bg-3.png')) ?>"
                                            alt="background"></li>
                                </ul>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="currency-icon warning"><img class="img-fluid"
                                                    src="<?= e(asset('assets/images/dashboard-2/order/sub-product/16.png')) ?>"
                                                    alt=""></div>
                                            <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                    href="<?= e(route('admin.products_details')) ?>">Bag</a>
                                                <p class="c-o-light" href="<?= e(route('admin.checkout')) ?>">#452140 </p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Jenny Wilson</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="currency-icon warning"><img class="img-fluid"
                                                    src="<?= e(asset('assets/images/dashboard-2/order/sub-product/25.png')) ?>"
                                                    alt=""></div>
                                            <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                    href="<?= e(route('admin.products_details')) ?>">Sofa</a>
                                                <p class="c-o-light" href="<?= e(route('admin.checkout')) ?>">#844967</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Esther Howard</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="currency-icon warning"><img class="img-fluid"
                                                    src="<?= e(asset('assets/images/dashboard-2/order/sub-product/26.png')) ?>"
                                                    alt=""></div>
                                            <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                    href="<?= e(route('admin.products_details')) ?>">Lamp</a>
                                                <p class="c-o-light" href="<?= e(route('admin.checkout')) ?>">#321489</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="currency-icon warning"><img class="img-fluid"
                                                    src="<?= e(asset('assets/images/dashboard-2/order/sub-product/24.png')) ?>"
                                                    alt=""></div>
                                            <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                    href="<?= e(route('admin.products_details')) ?>">Watch</a>
                                                <p class="c-o-light" href="<?= e(route('admin.checkout')) ?>">#954687</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="currency-icon warning"><img class="img-fluid"
                                                    src="<?= e(asset('assets/images/dashboard-2/order/sub-product/6.png')) ?>"
                                                    alt=""></div>
                                            <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                    href="<?= e(route('admin.products_details')) ?>">Football</a>
                                                <p class="c-o-light" href="<?= e(route('admin.checkout')) ?>">#896748</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Darrell Steward</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="currency-icon warning"><img class="img-fluid"
                                                    src="<?= e(asset('assets/images/dashboard-2/order/sub-product/10.png')) ?>"
                                                    alt=""></div>
                                            <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                    href="<?= e(route('admin.products_details')) ?>">T-shirt</a>
                                                <p class="c-o-light" href="<?= e(route('admin.checkout')) ?>">#321489</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="currency-icon warning"><img class="img-fluid"
                                                    src="<?= e(asset('assets/images/dashboard-2/order/sub-product/11.png')) ?>"
                                                    alt=""></div>
                                            <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                    href="<?= e(route('admin.products_details')) ?>">Sleeper</a>
                                                <p class="c-o-light" href="<?= e(route('admin.checkout')) ?>">#452140 </p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="currency-icon warning"><img class="img-fluid"
                                                    src="<?= e(asset('assets/images/dashboard-2/order/sub-product/14.png')) ?>"
                                                    alt=""></div>
                                            <div> <a class="f-14 mb-0 f-w-500 c-light"
                                                    href="<?= e(route('admin.products_details')) ?>">Shoes</a>
                                                <p class="c-o-light" href="<?= e(route('admin.checkout')) ?>">#844967</p>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="col-xxl-3 col-lg-4 col-sm-6 box-col-4 ord-xl-7 ord-md-2 box-ord-7">
            <div class="card buy-card"><img class="img-fluid"
                    src="<?= e(asset('assets/images/dashboard/purchase1.png')) ?>" alt="vector mens with laptop">
                <div class="card-body">
...
<script src="<?= e(asset('assets/js/chart/apex-chart/apex-chart.js')) ?>"></script>
<script src="<?= e(asset('assets/js/chart/apex-chart/stock-prices.js')) ?>"></script>
<script src="<?= e(asset('assets/js/counter/counter-custom.js')) ?>"></script>
<script src="<?= e(asset('assets/js/notify/bootstrap-notify.min.js')) ?>"></script>
<script src="<?= e(asset('assets/js/dashboard/default.js')) ?>"></script>
<script src="<?= e(asset('assets/js/notify/index.js')) ?>"></script>
<script src="<?= e(asset('assets/js/datatable/datatables/jquery.dataTables.min.js')) ?>"></script>
<script src="<?= e(asset('assets/js/datatable/datatables/dataTables.js')) ?>"></script>
<script src="<?= e(asset('assets/js/datatable/datatables/dataTables.select.js')) ?>"></script>
<script src="<?= e(asset('assets/js/datatable/datatables/select.bootstrap5.js')) ?>"></script>
<script src="<?= e(asset('assets/js/datatable/datatables/datatable.custom.js')) ?>"></script>
<script src="<?= e(asset('assets/js/typeahead/handlebars.js')) ?>"></script>
<script src="<?= e(asset('assets/js/typeahead/typeahead.bundle.js')) ?>"></script>
<script src="<?= e(asset('assets/js/typeahead/typeahead.custom.js')) ?>"></script>
<script src="<?= e(asset('assets/js/typeahead-search/handlebars.js')) ?>"></script>
<script src="<?= e(asset('assets/js/typeahead-search/typeahead-custom.js')) ?>"></script>
<?php $__view->endSection(); ?>