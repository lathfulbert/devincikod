...
<head>
  ...
  <meta name="description" content="Flexible, powerful, clean &amp; modern responsive bootstrap 5 admin template with unlimited possibilities.">
  ...
  <title>@yield('title') | FrameWork - DavinciKod</title>
  <!-- Google font-->
