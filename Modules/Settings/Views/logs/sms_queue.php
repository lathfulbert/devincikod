        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <h5>📱 Logs SMS Queue (ProcessPendingSmsTask)</h5>
                    <div>
                        ...
                        <button onclick="clearLog('sms_queue')" class="btn btn-sm btn-danger">🗑️ Vider les logs</button>
                        ...
                        <div class="bg-dark text-light p-3 rounded" style="max-height: 600px; overflow-y: auto; font-family: monospace; font-size: 12px;">
                            ...
                            <?php else: ?>
                                <?php foreach ($logs as $line): ?>
                                    <?php
                                    $class = '';
                                    if (stripos($line, 'Dispatched') !== false) {
                                        $class = 'text-info';
